...
class ExperimentAdmin (admin.ModelAdmin):
    ...
    list_display = (
        ...
        'ionisation_method', 'detection_method', 'id'
    )
...
class ExperimentalConditionAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('name', 'description', 'experiment', 'id')
...
class SampleAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('name', 'description', 'experimental_condition', 'organism', 'id')
...
class FragmentationSetAdmin(admin.ModelAdmin):
    ...
    """
    list_display = ('name', 'experiment', 'time_created', 'status', 'id')
...
class AnnotationQueryAdmin(admin.ModelAdmin):
    ...
    list_display = (
        ...
        'status', 'id', 'annotation_tool', 'annotation_tool_params',
    )
...
class PeakAdmin(admin.ModelAdmin):
    ...
    list_display = (
        ...
        'id', 'preferred_candidate_annotation',
    )
