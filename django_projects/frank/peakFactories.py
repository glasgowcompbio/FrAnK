...
from frank.models import Peak, SampleFile, FragmentationSet, Experiment
from decimal import *
...
class MSNPeakBuilder(PeakBuilder):
    ...
    def __init__(self, output, fragmentation_set_id, experiment_id):
        """
    ...
    def _create_ms1_peak(self, ms1_peak_object):
        ...
        pimp_id_list = ms1_peak_object.pimp_id_list
        ...
        try:
            ...
            if pimp_id_list is not None:
                for pimp_id in pimp_id_list:
